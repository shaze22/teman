  ...
  return (
    <div className="space-y-3">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">
                Setelah anda sahkan, bayaran akan dilepaskan kepada Teman anda. Pastikan anda berpuas hati dengan perkhidmatan yang diberikan.
              </p>
            </div>
          </div>
          <button
      ...
      {!isProvider && released && (
        <div className="bg-emerald-50 border border-emerald-200 rounded-2xl p-5 flex items-center gap-3">
          <ShieldCheck className="w-5 h-5 text-emerald-600 flex-shrink-0" />
          <p className="text-sm font-semibold text-emerald-700">Bayaran telah dilepaskan kepada Teman anda. Terima kasih!</p>
        </div>
      )}
