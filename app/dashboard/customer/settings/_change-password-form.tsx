    ...
    <div>
      ...
      >
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-lg bg-[#FFF1F2] flex items-center justify-center">
        ...
        <span className="text-xs text-[#F43F5E] font-medium">{open ? 'Tutup' : 'Tukar'}</span>
      </button>
            ...
            <>
              <div>
                ...
                <div className="relative">
                  <input type={showPw ? 'text' : 'password'} value={current} onChange={e => setCurrent(e.target.value)}
                    className="w-full px-3 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#F43F5E]/30 pr-10"
              ...
              <div>
                ...
                <input type="password" value={next} onChange={e => setNext(e.target.value)}
                  className="w-full px-3 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#F43F5E]/30"
              ...
              <button type="submit" disabled={loading}
                className="w-full bg-[#F43F5E] text-white py-2.5 rounded-xl text-sm font-semibold hover:bg-[#E11D48] disabled:opacity-50 transition-colors">
